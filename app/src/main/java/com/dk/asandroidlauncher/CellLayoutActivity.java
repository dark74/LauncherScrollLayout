...
import com.dk.asandroidlauncher.widget.cell.CellLayout;

public class CellLayoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cell_layout);
